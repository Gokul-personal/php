                    ...
                    <div role="tabpanel" class="tab-pane active" id="resentnewcar">
                        <div class="col-list-3">
                            <div class="recent-car-list">
                                <div class="car-info-box"> <a href="fruits.php?vhid=1"><img src="Image/Fruit/Mango.jpg<?php echo htmlentities($result->Vimage1); ?>" width="357px" height="245px" alt="image"></a></div>
                                ...
                                <div class="inventory_info_m">
                                    <p>The mango is a stone fruit which belongs to the Anacardiaceae family, which are flowering
                                        ...
                                        taste, vibrant color, and rich nutritional profile. mango cultivated...</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-list-3">
                            <div class="recent-car-list">
                                <div class="car-info-box"> <a href="fruits.php?vhid=2"><img src="Image/Fruit/watermelon.jpg<?php echo htmlentities($result->Vimage1); ?>" width="357px" height="245px" alt="image"></a></div>
                                <div class="car-title-m">
                        ...
                        <div class="col-list-3">
                            <div class="recent-car-list">
                                <div class="car-info-box"> <a href="fruits.php?vhid=3"><img src="Image/Fruit/jackfruit.jpg<?php echo htmlentities($result->Vimage1); ?>" width="357px"  height="245px" alt="image"></a></div>
                                <div class="car-title-m">
                                ...
                                <div class="inventory_info_m">
                                    <p>Jackfruit (Artocarpus heterophyllus) is a large tropical fruit that is gaining popularity
                                        ...
                                        evergreen, latex-produc-up to 80 feet in height, with a straight stem that..</p>
                                </div>
                            </div>
                        </div>
                    </div>
